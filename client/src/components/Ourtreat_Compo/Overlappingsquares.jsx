...
//           width: 500,
//           height: 450,
//           border: "3px solid black", // Border around the entire collection
//           borderRadius: "8px", // Optional: rounded corners
//           padding: "5px", // Small padding to avoid images touching the border
//         }}
//         variant="woven"
//         cols={3}
//         gap={8}
...
//       <ImageList
//         sx={{
//           width: isSmallScreen ? 300 : isMediumScreen ? 500 : 500, // Adjust width
//           height: isSmallScreen ? 300 : isMediumScreen ? 400 : 450, // Adjust height
//           border: "3px solid black",
//           borderRadius: "8px",
//           padding: "5px",
//         }}
//         variant="woven"
//         cols={isSmallScreen ? 2 : isMediumScreen ? 3 : 4} // Adjust columns
//         gap={8}
//       >
//         {itemData.map((item) => (
//           <ImageListItem key={item.img} onClick={() => handleImageClick(item.img)}>
...
//       <ImageList
//         sx={{
//           width: isSmallScreen ? '88%' : isMediumScreen ? 500 : 500, // Responsive width
//           height: isSmallScreen ? 300 : isMediumScreen ? 400 : 450, // Responsive height
//           border: "3px solid black",
//           borderRadius: "8px",
//           padding: "5px",
//           margin: "auto", // Ensures equal left-right margins
//           maxWidth: "500px", // Limits width on large screens
//         }}
//         variant="woven"
//         cols={isSmallScreen ? 2 : isMediumScreen ? 3 : 4} // Responsive column count
//         gap={8}
//       >
//         {itemData.map((item) => (
//           <ImageListItem key={item.img} onClick={() => handleImageClick(item.img)}>
...
//       <ImageList
//         sx={{
//           width: isSmallScreen ? '88%' : isMediumScreen ? 400 : 500, // Tablet width reduced to 400px
//           height: isSmallScreen ? 250 : isMediumScreen ? 350 : 500, // Tablet height reduced to 350px
//           border: "3px solid black",
//           borderRadius: "8px",
//           padding: "5px",
//           margin: "auto", // Ensures equal left-right margins
...
//             left: '50%',
//             transform: 'translate(-50%, -50%)',
//             width: isSmallScreen ? '90%' : isMediumScreen ? '70%' : '60%', // Tablet modal width reduced to 70%
//             maxWidth: '500px',
//             backgroundColor: 'white',
//             padding: '20px',
//             borderRadius: '8px',
