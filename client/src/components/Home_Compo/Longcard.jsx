...
const Longcard = ({ title, description }) => {
    return (
      <div className="relative flex justify-center items-center">
        ...
        {/* Foreground Card */}
        <div className=" group relative w-[550px] p-6 bg-white rounded-2xl shadow-lg border hover:shadow-2xl transition duration-300 ease-in-out hover:bg-[#E2B68F] hover:border-transparent">
