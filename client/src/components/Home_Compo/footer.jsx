      ...
      <div className="container mx-auto grid md:grid-cols-3 gap-10">
        ...
        <div>
          <div className="flex items-center space-x-4">
            <img src={logo} alt="Lankapura Wedamadura" className="w-32 mb-4" />
            
            <div className="flex flex-col text-white">
              <span className="text-lg md:text-xl lg:text-3xl font-normal leading-tight font-[Raleway]">
                LANKAPURA
              </span>
              <span className="text-lg md:text-xl lg:text-3xl font-normal leading-tight font-[Raleway]">
                WEDAMADURA
          ...
          <p className="text-sm leading-relaxed mt-4">
            Discover the essence of wellness at our Ayurvedic Medical Center. Experience holistic healing through ancient traditions, tailored treatments, and natural remedies. Rejuvenate your body, mind, and spirit with our expert care and personalized therapies.
          </p>
        ...
        <div className="md:ml-40"> {/* Adjusted to move further right */}
        ...
        <div>
          ...
          <p className="flex items-center"><MdLocationOn className="mr-2" /> Perumanagoda, Aluthwala, Ambalangoda</p>

          <h3 className="text-lg font-semibold mt-4">Contact No.</h3>
          <p className="flex items-center mt-4"><MdPhone className="mr-2" /> +94 91 79 14 202</p>
          <p className="flex items-center"><MdPhone className="mr-2" /> +94 77 85 80 474</p>

          <h3 className="text-lg font-semibold mt-4">Email</h3>
          <p className="flex items-center mt-4"><MdEmail className="mr-2" /> wickramasooriyatharanga@gmail.com</p>
        </div>
      </div>

      {/* Bottom Section */}
      <div className="border-t border-gray-600 mt-8 pt-4 flex flex-col md:flex-row justify-between items-center text-sm">
        <p>&copy; {new Date().getFullYear()} Lankapura Wedamadura. All Rights Reserved.</p>
